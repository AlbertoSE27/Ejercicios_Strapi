...
export interface ApiClassClass extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    aditionalDetails: Schema.Attribute.Component<
      'classes.aditional-details',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTeacherTeacher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    additionalDetails: Schema.Attribute.Component<
      'teachers.additional-details',
      true
    >;
...
export interface ApiTopicTopic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    asignature: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
